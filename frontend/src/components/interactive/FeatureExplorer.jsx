...
const FEATURES = [
  {
    ...
    previewTitle: 'Payment Server (AST-001) FAIR Breakdown',
    stat1: { label: 'Likelihood', value: '18.0% / yr' },
    stat2: { label: 'Single Loss Event', value: '₹4.00 Crores' },
    stat3: { label: 'Expected Annual Loss', value: '₹72.0 Lakhs' },
    formula: 'EAL = 18.0% Likelihood × [ ₹1.2Cr Downtime + ₹1.5Cr Breach + ₹80L DPDP + ₹30L Recovery + ₹20L Disruption ] = ₹72.0 Lakhs/yr',
  },
  {
    id: 'monte_carlo',
    tab: 'monte_carlo',
    ...
    stat1: { label: 'Mean Annual Loss', value: '₹1.84 Crores' },
    stat2: { label: 'P90 Tail Loss', value: '₹5.91 Crores' },
    stat3: { label: '95% Value at Risk', value: '₹7.59 Crores' },
    formula: '95% of simulated scenarios fall below ₹7.59 Crores. Compound Log-Normal dispersion factor σ = 0.35.',
  },
  {
    id: 'optimizer',
    tab: 'optimizer',
    ...
    stat1: { label: 'Allocated Budget', value: '₹25.0 Lakhs' },
    stat2: { label: 'Risk Reduction', value: '₹1.05 Crores' },
    stat3: { label: 'Portfolio ROSI', value: '4.2x Multiplier' },
    formula: 'Dynamic Programming state matrix selects Emergency Patching + FIDO2 MFA + DAM to eliminate 57.1% of baseline exposure.',
  },
  {
    id: 'what_if',
    tab: 'what_if',
    ...
    stat1: { label: 'Baseline Score', value: '72 / 100' },
    stat2: { label: 'Post-Remediation', value: '31 / 100 (−41 pts)' },
    stat3: { label: 'Net Financial Value', value: '₹80.0 Lakhs' },
    formula: 'Instantly quantifies exposure shift: Baseline ₹1.84 Cr → Simulated Residual ₹79.0 Lakhs.',
  },
  {
    id: 'compliance',
    tab: 'compliance',
  ...
  },
  {
    ...
    stat3: { label: 'Total Kill Chain Risk', value: '₹4.00 Crores' },
